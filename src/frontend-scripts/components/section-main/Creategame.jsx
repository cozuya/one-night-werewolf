					...
					<div className="row">
						...
						<div className="column minion">
							...
							<div className="ui small popup bottom right transition hidden">
								Minions wake up, and get to see who the werewolves are - but they are not aware of the minion.  Minions win if the werewolves win, and in the avent of no werewolves, win if a villager dies.  Minions are on the <span>werewolf team.</span>
							</div>
							<i className="minus icon"></i>
							<span>0</span>
							<i className="plus icon"></i>
						...
						<div className="column">
							<p>Robber</p>
							<div className="ui small popup bottom right transition hidden">
								Robbers wake up, and select a player's card.  They then swap that player's card with their own, and become the role and team they have stolen (and vice versa) - however they do not do an additional night action.  Robbers are on the <span>village team.</span>
							</div>
							<i className="minus icon"></i>
							<span>0</span>
							<i className="plus icon"></i>
